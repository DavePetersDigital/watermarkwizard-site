      ...
      <div className="prose prose-lg max-w-none">
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            Watermark Wizard is a simple, offline-first application that allows you to add professional watermarks to images in seconds.
          </p>
          <p className="text-gray-700 mb-4">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
            ...
            <li>Anyone who wants to protect images before publishing them online</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            The correct version of the software can be downloaded from{" "}
        ...
        <section className="mb-12">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-700">
            ...
            <li>Click Help &gt; Enter/Change License Key</li>
          ...
          <div className="mb-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
              <p className="text-blue-900">
                <strong>Note:</strong> If your Watermark image has a transparent background then in this box it will show with a grey background for preview purposes, this helps with watermarks that are white in colour, the exported image will keep the transparent background.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div>
                <p className="text-gray-700 mb-2">
                  <strong>Scale</strong> – Controls the maximum width of the image that the watermark will use, the default (and maximum) is 15% this represents a reasonable size watermark but can be reduced.
                </p>
              </div>
              <div>
                <p className="text-gray-700 mb-2">
                  <strong>Opacity</strong> – Controls how visible the watermark is. A higher value makes the watermark more solid and visible, while a lower value makes it more transparent.
                </p>
              ...
              <div>
                <p className="text-gray-700 mb-2">
                  <strong>Centre Size Multiplier</strong> – Controls the size of the image if the center position is selected, the maximum is 2.00.
                </p>
              </div>
              <div>
                <p className="text-gray-700 mb-2">
                  <strong>Filename Suffix</strong> – Controls what the watermark file will be called, the watermarked file will be created using the existing file name suffixed with whatever is entered into this box.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            Email <a href="mailto:support@davepetersdigital.com" className="text-purple-600 hover:text-purple-700 font-semibold">support@davepetersdigital.com</a> with:
          </p>
          <ul className="list-disc list-inside text-gray-700 space-y-2">
